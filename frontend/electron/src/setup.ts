    ...
    callback({
      responseHeaders: {
        ...
        'Content-Security-Policy': [
          electronIsDev
            ? `default-src ${customScheme}://* 'unsafe-inline' devtools://* 'unsafe-eval' data: https://voyagr.me`
            : `default-src ${customScheme}://* 'unsafe-inline' data: https://voyagr.me`,
        ],
      },
    });
  });
